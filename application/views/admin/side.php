                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <?php if(pg_admin()): ?>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Inventaris </span></a>
                                <ul aria-expanded="false" class="collapse  first-level">
                                    ...
                                    <li class="sidebar-item"><a href="<?= base_url('index.php/admin/gtk') ?>" class="sidebar-link"><i class="mdi mdi-human-male-female"></i><span class="hide-menu"> Guru dan Tendik </span></a></li>
                                    <li class="sidebar-item"><a href="<?= base_url('index.php/admin/snp') ?>" class="sidebar-link"><i class="mdi mdi-animation"></i><span class="hide-menu"> Sarpras Barang </span></a></li>
                                    <li class="sidebar-item"><a href="<?= base_url('index.php/admin/nonsnp') ?>" class="sidebar-link"><i class="mdi mdi-plus"></i><span class="hide-menu"> Non Sarpras Barang </span></a></li>
                        ...
                        <ul aria-expanded="false" class="collapse  first-level"></li>
