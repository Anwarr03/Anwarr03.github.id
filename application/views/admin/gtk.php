                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Guru dan Tendik</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div style="margin-bottom: 10px">
                    <button type="button" data-toggle="modal" data-target="#modal-tambah-gtk"><span class="fa fa-plus"></span> Tambah Guru dan Tendik</button>
                    <button type="button" data-toggle="modal" data-target="#modal-hapus"><span class="fa fa-trash"></span> Hapus Semua Guru dan Tendik</button>
                </div>


                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data Guru dan Tendik</h5>
