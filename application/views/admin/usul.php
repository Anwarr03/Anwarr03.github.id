                ...
                <form action="<?= base_url('index.php/tambah/usulanBarang') ?>" method="post" id="usulanBarang">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <!-- <select name="namabarang" id="" class="form-control" required="">
                                <option value="">Nama Barang</option>
    <?php foreach ($usulan as $oy):?>
                                    <option value=""><?php echo $oy['namaBarang'] ?></option>
                             <?php endforeach;?>
                                </div>
                            </select> -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="kiraHarga">Perkiraan Harga Barang Satuan</label>
                            <input type="number" name="kiraHarga" class="form-control" required="" placeholder="Perkiraan harga barang satuan">
                        </div>

                        <div class="form-group">
                            <label for="keperluan">Keperluan</label>
                            <input type="text" name="keperluan" class="form-control" required="" placeholder="Pembelajaran / Lomba dll">
                        </div>
